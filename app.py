...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://admin:TtCE{_Q)MN73N64[xX5nu}yLPX7P@database-1.chge4i04izsn.ap-southeast-1.rds.amazonaws.com/User'
...
def create_user():
    data = request.json
    new_user = AppUser(name=data['name'], email=data['email'])
